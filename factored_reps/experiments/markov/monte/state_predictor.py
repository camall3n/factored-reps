...
from factored_reps.envs.monte.fakemonteenv import FakeMonteEnv
...
filepaths = glob.glob('monte-results/logs/monte{:02d}*/args-{}.txt'.format(
    args.experiment, args.seed))
