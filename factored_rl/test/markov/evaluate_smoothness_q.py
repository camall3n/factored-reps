...
if args.phi_path:
    modelfile = 'results/gridworld/models/{}/phi-{}_latest.pytorch'.format(args.phi_path, args.seed)
...
agent = DQNAgent(n_features=args.latent_dims,
                 ...
                 factored=False)
if args.phi_path:
    modelfile = 'results/gridworld/models/{}/qnet-{}_latest.pytorch'.format(args.phi_path, args.seed)
