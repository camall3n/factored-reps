...
from factored_rl.experiments.factorize.analysis.heatmaps import add_heatmap_labels, diagonalize
...
parser.add_argument('--hyperparams', type=str, default='factored_rl/hyperparams/factorize-taxi.csv',
